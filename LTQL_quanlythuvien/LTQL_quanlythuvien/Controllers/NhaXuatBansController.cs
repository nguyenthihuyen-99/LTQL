    ...
    public class NhaXuatBansController : Controller
    {
        ...
        public ActionResult UploadExcelFile(HttpPostedFileBase file)
        {
            //try
            {
                ...
                {
                    //Your code
                    string _FileName = "NhaXuatBan.xlsx";
                    //duong dan luu file
        ...
        public DataTable ReadDataFromExcelFile(string filepath)
        {
            ...
            try
            {
                ...
                OleDbCommand cmd = new OleDbCommand("SELECT * FROM [NXB$]", oledbConn);
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            con.Open();
            bulkcopy.DestinationTableName = "NhaXuatBans";
            bulkcopy.ColumnMappings.Add(0, "MaNXB");
            bulkcopy.ColumnMappings.Add(1, "TenNXB");
        ...
        public ActionResult DownloadFile()
        {
            ...
            byte[] fileBytes = System.IO.File.ReadAllBytes(path + "NhaXuatBan.xlsx");
            //ten file khi download ve
            string fileName = "NhaXuatBan.xlsx";
            //tra ve file
